...
export const SECTIONS: Section[] = [
  ...
  {
    key: "next_stream_at",
    label: "Next Stream Time",
    description: "Drives the countdown on the homepage and schedule page.",
    kind: "object",
    fields: [{ key: "date", label: "Date & Time", type: "datetime" }],
  },
  {
    key: "schedule",
    label: "Weekly Schedule",
    description: "One row per day, Monday through Sunday.",
    kind: "list",
    hasId: false,
    fixedRows: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
    fields: [
      { key: "day", label: "Day", type: "text" },
      { key: "date", label: "Date label", type: "text" },
      { key: "time", label: "Time", type: "text" },
      { key: "title", label: "Session title", type: "text" },
      { key: "live", label: "Live now", type: "boolean" },
      { key: "off", label: "Day off", type: "boolean" },
    ],
  },
  {
    key: "community_stats",
